...
class Ui_MainWindow1(object):
    ...
    def startSniffing(self):
        Rbackground = bool(self.checkBox.checkState())
        AblockIP = bool(self.checkBox_2.checkState())
        AllowNotification = bool(self.checkBox_3.checkState())
        #self.myapp2 = MyDialog2([Rbackground,AblockIP,AllowNotification])
        #self.myapp2.show()
        m=Ui_MainWindow2()
        self.myapp2=m.setupUi(MainWindow)
        self.myapp2.show()
    def help(self):
